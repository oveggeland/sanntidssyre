...
#	require _Destributor_
	...
	def _check_all_buttons(heisPID, floors, button_types) do
		...
		cond do
			...
			button_types == [] ->
				[_head | tail] = floors
				{_floors_pressed, _button_type_pressed} = _check_all_buttons(heisPID, tail, [:hall_up, :hall_down, :cab])
...
#					_Destributor_.WeGotsNewOrders({floor_head, order_head)  
				end
		end
	end
